  ...
  return (
    <section className="relative w-full min-h-[calc(100dvh-64px)] lg:h-[calc(100dvh-64px)] bg-section-surface text-slate-900 overflow-hidden flex flex-col lg:flex-row items-center font-sans tracking-tight">
      ...
      <div className="w-full lg:w-5/12 h-full flex flex-col justify-center px-6 sm:px-12 lg:pl-16 xl:pl-24 z-10 shrink-0 py-12 lg:py-0">
        ...
        {/* Eyebrow Label — Standard format */}
        <div className="eyebrow-wrap justify-start !mb-4 sm:!mb-6">
        ...
        <div className="relative card max-w-[500px] mt-3 lg:mt-6 overflow-hidden">
          ...
          <p className="premium-p pl-2">
            ...
            <strong className="text-brand-indigo-600 font-bold block mt-2 flex items-center gap-2 cursor-pointer hover:text-brand-indigo-700 transition-colors w-fit">
      ...
      <div className="w-full lg:w-7/12 h-full flex items-center justify-center perspective-container z-10 p-2 sm:p-8 shrink-0 py-8 lg:py-0">
        ...
        <div className="relative w-full max-w-[500px] scale-90 sm:scale-100">
          ...
          <div className="absolute inset-[-20px] border border-brand-indigo-200/50 rounded-3xl bg-white/60 shadow-sm" />
          ...
          <div className="w-full bg-white border border-slate-200 rounded-xl py-2 px-3 sm:py-3 sm:px-4 flex justify-between items-center relative z-30 shadow-card-lg">
            <div>
              <p className="text-[10px] sm:text-xs font-bold uppercase tracking-widest text-brand-indigo-600 mb-0.5">Doctor Writes</p>
              <p className="text-xl sm:text-2xl font-bold text-slate-900 tracking-tight">100% Rx Value</p>
            </div>
          ...
          <div className="flex flex-col gap-0.5 sm:gap-1.5 relative z-20 my-1.5">
            ...
            <div className="flex w-full items-stretch">
              ...
              <div className="w-16 sm:w-20 flex justify-center relative shrink-0 z-10">
                ...
                <div className="absolute right-[-24px] sm:right-[-32px] top-1/2 -translate-y-1/2 w-12 sm:w-16 h-[4px] bg-brand-indigo-200 rounded-full overflow-hidden border-y border-brand-indigo-200/50 z-0 shadow-sm">
                ...
                <div className="bg-white border border-slate-200 py-1.5 sm:py-2 px-3 sm:px-4 rounded-xl flex items-center gap-3 sm:gap-4 shadow-card hover:shadow-card-md transition-all hover:border-brand-indigo-300 group">
                  ...
                  <div>
                    <div className="flex items-baseline gap-2 mb-0.5">
                      ...
                      <span className="text-brand-indigo-600 font-bold text-[10px] sm:text-xs">Ops Loss</span>
                    </div>
                ...
                <div className="bg-white border border-slate-200 py-1.5 sm:py-2 px-3 sm:px-4 rounded-xl flex items-center gap-3 sm:gap-4 shadow-card hover:shadow-card-md transition-all hover:border-brand-indigo-300 group">
                  ...
                  <div>
                    <div className="flex items-baseline gap-2 mb-0.5">
                      ...
                      <span className="text-brand-indigo-600 font-bold text-[10px] sm:text-xs">Walk-outs</span>
                    </div>
                ...
                <div className="bg-white border border-slate-200 py-1.5 sm:py-2 px-3 sm:px-4 rounded-xl flex items-center gap-3 sm:gap-4 shadow-card hover:shadow-card-md transition-all hover:border-brand-indigo-300 group">
                  ...
                  <div>
                    <div className="flex items-baseline gap-2 mb-0.5">
                      ...
                      <span className="text-brand-indigo-600 font-bold text-[10px] sm:text-xs">Chronic Loss</span>
                    </div>
          ...
          <div className="w-[95%] ml-auto bg-brand-indigo-600 border border-brand-indigo-400/30 rounded-xl py-2 px-3 sm:py-3 sm:px-4 flex justify-between items-center relative z-30 shadow-glow">
            <div>
              <p className="text-[10px] sm:text-xs font-bold uppercase tracking-widest text-white/90 mb-0.5">Revenue Captured</p>
              <p className="text-xl sm:text-2xl font-bold text-white tracking-tight">&lt; 50% Final Value</p>
            </div>
            <div className="w-9 h-9 sm:w-10 sm:h-10 rounded-full border border-brand-indigo-200 flex items-center justify-center bg-white shadow-sm shrink-0">
