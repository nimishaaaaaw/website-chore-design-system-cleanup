      ...
      <div className="container-page relative z-10">
        ...
        <div className="text-center mb-16 md:mb-24">
          <motion.div
            ...
            viewport={{ once: true }}
            className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-white/5 border border-white/10 mb-5 shadow-card"
          >
          ...
          <motion.p
            ...
            className="text-body-lg text-slate-400 max-w-2xl mx-auto font-medium"
          >
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 md:gap-0">
          {STEPS.map((step, i) => (
            ...
            >
              <div className={`w-14 h-14 rounded-2xl ${step.solid} flex items-center justify-center mb-6 shadow-card-lg group-hover:scale-110 transition-transform duration-300`}>
