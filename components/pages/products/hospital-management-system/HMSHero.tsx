            ...
            <div className="relative z-10 bg-white/80 backdrop-blur-2xl border border-white/80 shadow-card-lg rounded-[2.5rem] p-6 lg:p-8 ring-1 ring-slate-900/5 overflow-hidden flex flex-col">
              ...
              <div className="flex items-center justify-between mb-6 pb-4 border-b border-muted">
                <div className="flex items-center gap-3">
                  <div className="w-10 h-10 rounded-xl bg-indigo-50 flex items-center justify-center border border-indigo-100 shadow-sm" style={{ color: 'var(--indigo-600)' }}>
                    <LayoutGrid className="w-5 h-5" />
                  </div>
                  <div>
                    <h4 className="text-sm font-bold tracking-tight leading-none mb-1" style={{ color: 'var(--text-primary)' }}>MediKloud OS</h4>
                    <p className="text-xs font-semibold uppercase tracking-widest" style={{ color: 'var(--text-muted)' }}>Live Patient Journey</p>
                  </div>
                </div>
                <div className="badge badge-success flex items-center gap-2">
                  ...
                  <span className="text-xs font-semibold tracking-widest uppercase">End-to-End</span>
                </div>
              </div>
                ...
                {[
                  ...
                  return (
                    <div key={i} className="absolute -translate-x-1/2 -translate-y-1/2 flex flex-col items-center z-20" style={{ left: node.x, top: node.y }}>
                      ...
                      <span className="text-[8px] font-bold uppercase tracking-widest bg-white/90 px-1.5 py-0.5 rounded backdrop-blur-sm border border-slate-100 shadow-sm" style={{ color: 'var(--text-body)' }}>
                        {node.name}
                      </span>
                    </div>
                  );
              ...
              <div className="bg-gradient-to-br from-slate-50 to-purple-50/50 rounded-xl p-4 border border-purple-100 flex items-center justify-between no-select">
                <div>
                  ...
                  <div className="flex items-baseline gap-2">
                    <h4 className="text-xl font-bold leading-none tracking-tight" style={{ color: 'var(--text-primary)' }}>
                      Reduced by <span style={{ color: 'var(--indigo-600)' }}>65%</span>
                    </h4>
                  </div>
                </div>
