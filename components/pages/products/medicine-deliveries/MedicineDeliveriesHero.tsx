...
export const MedicineDeliveriesHero = () => {
              ...
              <div className="flex items-center justify-between mb-8 pb-4 border-b border-slate-100/60 no-select">
                 <div className="flex items-center gap-3">
                   ...
                   <div>
                     ...
                     <p className="text-[10px] font-semibold text-slate-400 uppercase tracking-widest">Real-time Routing</p>
                   </div>
                 </div>
                 <div className="bg-emerald-50 text-emerald-600 px-3 py-1.5 rounded-full border border-emerald-100 flex items-center gap-2 shadow-sm">
                   ...
                   <span className="text-[10px] font-semibold tracking-widest uppercase">Routing</span>
                 </div>
              </div>
                 ...
                 <div className="absolute left-[5%] top-1/2 -translate-y-1/2 w-[120px] z-20">
                    <div className="relative bg-white/95 backdrop-blur-md border border-blue-100 p-3 rounded-2xl flex flex-col items-center gap-2 w-full shadow-lg">
                       ...
                       <div className="text-center w-full">
                          <div className="text-slate-900 font-bold text-[10px] uppercase tracking-wider">Hospital</div>
                          <div className="text-blue-600 text-[8px] uppercase tracking-widest mt-0.5 font-semibold">Pharmacy</div>
                       </div>
                    </div>
                 </div>
              ...
              <div className="grid grid-cols-2 gap-4 mt-auto">
                 <div className="p-3 bg-slate-50 rounded-xl border border-slate-100 flex items-center gap-3">
                    ...
                    <div>
                       ...
                       <p className="text-[10px] font-bold text-slate-900 leading-none">100% Retained</p>
                    </div>
                 </div>
                 <div className="p-3 bg-blue-50/50 rounded-xl border border-blue-100 flex items-center gap-3">
                   ...
                   <div>
                       <p className="text-[8px] text-blue-400 font-semibold uppercase tracking-widest mb-0.5">Revenue</p>
                       <p className="text-[10px] font-bold text-slate-900 leading-none">Secured</p>
                    </div>
                 </div>
              </div>
            </div>
