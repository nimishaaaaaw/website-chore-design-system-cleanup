        ...
        <div className="lg:grid lg:grid-cols-12 lg:gap-16 items-start">
          ...
          <div className="lg:col-span-5 mb-16 lg:mb-0">
            ...
            <motion.div
              ...
              className="p-8 md:p-10 rounded-3xl relative overflow-hidden group shadow-card-lg ring-1 ring-white/10"
            >
              <DarkAtmosphere withMouseEffect={false} />

              <div className="relative z-10">
                <p className="text-indigo-400 font-bold uppercase tracking-widest text-xs mb-3 leading-none">Our Promise</p>
                <p className="text-h2 text-white font-bold leading-tight tracking-tight text-balance">
            ...
            <div className="grid sm:grid-cols-2 gap-4 lg:gap-6 mb-8">
              {economicModel.map((model, idx) => (
                <motion.div
                  ...
                  whileHover={{ y: -8 }}
                  className="bg-white p-8 rounded-3xl border border-slate-200 shadow-card hover:shadow-card-lg hover:border-brand-indigo-100 transition-all duration-300 group"
                >
                  <div className="w-12 h-12 rounded-xl flex items-center justify-center mb-6 border border-brand-indigo-100 shadow-card group-hover:scale-110 transition-all duration-500 bg-indigo-50 text-indigo-600 group-hover:bg-indigo-600 group-hover:text-white group-hover:border-transparent">
                    {model.icon}
                  </div>
                  <h3 className="text-h2 font-bold mb-3 tracking-tight text-slate-900 group-hover:text-indigo-600 transition-colors">
                    {model.title}
                  </h3>
