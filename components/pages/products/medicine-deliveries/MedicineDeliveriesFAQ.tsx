...
export const MedicineDeliveriesFAQ = () => {
  return (
    <section id="faq" className="relative bg-section-alt section-py border-t border-slate-100 overflow-hidden">
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            {faqItems.map((faq, index) => (
              <div
                key={index}
                className="card card--static rounded-2xl p-8"
              >
                <h3 className="text-h3 font-bold text-slate-900 mb-4">{faq.q}</h3>
                <p className="premium-p text-slate-600 leading-relaxed">
                  {faq.a}
                </p>
              </div>
            ))}
