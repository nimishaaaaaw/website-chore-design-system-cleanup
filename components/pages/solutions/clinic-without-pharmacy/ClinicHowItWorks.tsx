...
export const ClinicHowItWorks = () => {
  return (
    <section id="how-it-works" className="section-py bg-slate-50 relative overflow-hidden">
        ...
        >
          ...
          <motion.div variants={staggerContainer} className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {[
              ...
              >
                <div className="card h-full flex flex-col p-8 md:p-10 transition-all duration-300 group-hover:shadow-card-lg group-hover:-translate-y-1">
                  <div className="absolute top-6 right-8 text-slate-100 font-black text-6xl group-hover:text-slate-200 transition-colors pointer-events-none select-none">
                    {item.step}
                  </div>
                  
                  <div className="relative z-10 space-y-6">
                    <div className="w-14 h-14 rounded-2xl bg-white shadow-md border border-slate-100 flex items-center justify-center text-indigo-600 transition-transform group-hover:scale-110">
