      ...
      <div className="container-page relative z-10">
        ...
        >
          <div className="eyebrow-wrap justify-center">
            ...
            <span className="eyebrow-text text-rose-500">Diagnostic: The Operations Trap</span>
            <span className="eyebrow-line-r bg-rose-500/30" />
          </div>
          <h2 className="text-h2 font-black tracking-tight text-slate-900 leading-tight md:text-5xl">
        ...
        <div className="max-w-5xl mx-auto mt-20 lg:mt-32 space-y-24 lg:space-y-32">
          ...
          >
            <div className="flex-1 space-y-5">
              ...
              <h3 className="text-3xl md:text-4xl font-bold text-slate-900 tracking-tight">"I'll just buy it near my house."</h3>
            ...
            <div className="flex-1 w-full">
              <div className="bg-slate-50 border border-slate-100 rounded-[2.5rem] p-8 relative overflow-hidden group-hover:shadow-2xl group-hover:shadow-rose-500/10 group-hover:border-rose-100 transition-all duration-500">
                 <div className="text-[10px] font-bold text-slate-400 uppercase tracking-widest mb-6">Daily Prescription Flow</div>
                 ...
                 <div className="mt-6 pt-4 border-t border-slate-200 flex items-center justify-between relative z-10">
                    ...
                    <span className="text-sm font-black text-rose-500 flex items-center gap-1.5 bg-rose-50 px-2.5 py-1 rounded-lg border border-rose-100"><TrendingUp className="w-4 h-4 rotate-180" /> 58%</span>
                 </div>
          ...
          >
            <div className="flex-1 space-y-5">
              <span className="text-[11px] font-black uppercase tracking-widest text-amber-600 bg-amber-50 px-3 py-1.5 rounded-md border border-amber-100">
                Dead Stock
              </span>
              <h3 className="text-3xl md:text-4xl font-bold text-slate-900 tracking-tight">Money dying on the shelves.</h3>
              <p className="text-slate-500 text-lg leading-relaxed font-medium">
            ...
            <div className="flex-1 w-full">
              <div className="bg-slate-50 border border-slate-100 rounded-[2.5rem] p-8 relative overflow-hidden group-hover:shadow-2xl group-hover:shadow-amber-500/10 group-hover:border-amber-100 transition-all duration-500">
                 <div className="text-[10px] font-bold text-slate-400 uppercase tracking-widest mb-6">Inventory Health Alert</div>
                 ...
                 <div className="bg-white rounded-2xl p-5 border border-slate-100 shadow-sm relative z-10 space-y-4">
                    ...
                    <div className="bg-slate-50 rounded-xl p-3 border border-slate-100 flex justify-between items-center">
                       ...
                       <span className="text-[13px] font-black text-slate-800 font-mono">₹48,250</span>
                    </div>
                 </div>
          ...
          >
            <div className="flex-1 space-y-5">
              <span className="text-[11px] font-black uppercase tracking-widest text-slate-600 bg-slate-100 px-3 py-1.5 rounded-md border border-slate-200">
                Staff Headaches
              </span>
              <h3 className="text-3xl md:text-4xl font-bold text-slate-900 tracking-tight">Managing the counter.</h3>
              <p className="text-slate-500 text-lg leading-relaxed font-medium">
            ...
            <div className="flex-1 w-full">
              <div className="bg-slate-950 rounded-[2.5rem] p-8 relative overflow-hidden group-hover:shadow-2xl group-hover:shadow-slate-900/20 border border-slate-800 transition-all duration-500">
                 <div className="text-[10px] font-bold text-slate-500 uppercase tracking-widest mb-6">Daily Reconciliation</div>
          ...
          >
            <div className="flex-1 space-y-5">
              ...
              <h3 className="text-3xl md:text-4xl font-bold text-slate-900 tracking-tight">The one-time buyer.</h3>
              <p className="text-slate-500 text-lg leading-relaxed font-medium">
            ...
            <div className="flex-1 w-full">
              <div className="bg-slate-50 border border-slate-100 rounded-[2.5rem] p-8 relative overflow-hidden group-hover:shadow-2xl group-hover:shadow-rose-500/10 group-hover:border-rose-100 transition-all duration-500">
                 <div className="flex justify-between items-center mb-8 relative z-10">
                     <div className="text-[10px] font-bold text-slate-400 uppercase tracking-widest">Patient Retention Curve</div>
                 ...
                 <div className="flex items-end gap-4 h-[140px] relative z-10 px-2">
                    ...
                    <div className="absolute top-[-20px] right-0 text-[9px] font-bold text-slate-400 uppercase tracking-widest bg-slate-50 px-1">Ideal Retention</div>
                    ...
                    <div className="flex-1 flex flex-col items-center h-full justify-end relative z-10">
                      <motion.div initial={{ height: 0 }} whileInView={{ height: '100%' }} viewport={{ once: true }} transition={{ duration: 1, ease: "easeOut" }} className="w-full bg-slate-800 rounded-t-xl relative group-hover:bg-slate-900 transition-colors shadow-lg">
                        <span className="absolute -top-7 left-1/2 -translate-x-1/2 text-[13px] font-black text-slate-800">100%</span>
                      </motion.div>
                    </div>
                    {/* Month 2 */}
                    <div className="flex-1 flex flex-col items-center h-full justify-end relative z-10">
                      <motion.div initial={{ height: 0 }} whileInView={{ height: '30%' }} viewport={{ once: true }} transition={{ duration: 1, delay: 0.2, ease: "easeOut" }} className="w-full bg-gradient-to-t from-rose-600 to-rose-500 rounded-t-xl relative group-hover:from-rose-700 group-hover:to-rose-600 transition-colors shadow-[0_0_20px_rgba(244,63,94,0.4)]">
                        <span className="absolute -top-7 left-1/2 -translate-x-1/2 text-[13px] font-black text-rose-600">30%</span>
                      </motion.div>
                    </div>
                    {/* Month 3 */}
                    <div className="flex-1 flex flex-col items-center h-full justify-end relative z-10">
                      <motion.div initial={{ height: 0 }} whileInView={{ height: '10%' }} viewport={{ once: true }} transition={{ duration: 1, delay: 0.4, ease: "easeOut" }} className="w-full bg-gradient-to-t from-rose-500 to-rose-400 rounded-t-xl relative group-hover:from-rose-600 group-hover:to-rose-500 transition-colors shadow-[0_0_15px_rgba(244,63,94,0.3)]">
                        <span className="absolute -top-7 left-1/2 -translate-x-1/2 text-[13px] font-black text-rose-500">10%</span>
                      </motion.div>
                    </div>
                 </div>
                 ...
                 <div className="flex gap-4 px-2 mt-3 relative z-10 border-t-2 border-slate-200/80 pt-3">
                    <div className="flex-1 text-center"><span className="text-[10px] font-bold text-slate-500 uppercase tracking-widest">Month 1</span></div>
                    <div className="flex-1 text-center"><span className="text-[10px] font-bold text-rose-600 uppercase tracking-widest">Month 2</span></div>
                    <div className="flex-1 text-center"><span className="text-[10px] font-bold text-rose-500 uppercase tracking-widest">Month 3</span></div>
                 </div>
