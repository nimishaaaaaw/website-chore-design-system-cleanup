      ...
      <div className="container-page relative z-10">
        ...
        >
          <div className="eyebrow-wrap justify-center">
            ...
            <span className="eyebrow-text">The Reality of Pharmacy Management</span>
            <span className="eyebrow-line-r" />
          </div>
          <h2 className="premium-h2">
            Running a hospital is your job.<br/>
            <span className="heading-accent">Running a pharmacy shouldn't be.</span>
          </h2>
        ...
        <div className="max-w-5xl mx-auto mt-12 lg:mt-20 space-y-20 lg:space-y-24">
          ...
          >
            <div className="flex-1 space-y-5">
              <span className="text-sm font-bold text-rose-600 bg-rose-50 px-3 py-1 rounded-lg border border-rose-200 inline-block w-fit">
                Lost Prescriptions
              </span>
            ...
            <div className="flex-1 w-full">
              <div className="bg-white border border-slate-200 rounded-3xl p-8 relative overflow-hidden shadow-card hover:shadow-card-md hover:border-rose-200 transition-all duration-300">
                 <div className="flex items-center justify-between mb-8">
                    <div className="text-xxs font-bold text-slate-400 uppercase tracking-wider">Daily Prescription Flow</div>
                    <div className="h-1.5 w-8 bg-rose-500 rounded-full opacity-20" />
                 </div>
                 <div className="space-y-6 relative z-10">
                    <div>
                      <div className="flex justify-between text-xs font-bold text-slate-500 uppercase tracking-wide mb-3">
                    ...
                    <div>
                      <div className="flex justify-between text-xs font-bold text-rose-600 uppercase tracking-wide mb-3">
                 ...
                 <div className="mt-10 pt-6 border-t border-slate-100 flex items-center justify-between relative z-10">
                    <span className="text-xs font-bold text-slate-400 uppercase tracking-wider">Revenue Leakage</span>
          ...
          >
            <div className="flex-1 space-y-5">
              <span className="text-sm font-bold text-amber-600 bg-amber-50 px-3 py-1 rounded-lg border border-amber-200 inline-block w-fit">
            ...
            <div className="flex-1 w-full">
              <div className="bg-white border border-slate-200 rounded-3xl p-8 relative overflow-hidden shadow-card hover:shadow-card-md hover:border-amber-200 transition-all duration-300">
                 <div className="flex items-center justify-between mb-8">
                    <div className="text-xxs font-bold text-slate-400 uppercase tracking-wider">Inventory Health Alert</div>
                    <div className="h-1.5 w-8 bg-amber-500 rounded-full opacity-20" />
                 </div>
                 
                 <div className="relative z-10 space-y-3">
                    <div className="bg-white rounded-2xl p-4 border border-slate-100 shadow-card flex items-center justify-between group/row hover:border-amber-100 transition-colors duration-200">
                       <div className="flex items-center gap-3">
                          ...
                          <div>
                             ...
                             <div className="text-xs text-slate-400 font-medium font-mono uppercase tracking-tight">Batch: B8839 • 240 Strips</div>
                          </div>
                       </div>
                       <div className="text-right shrink-0">
                          <span className="text-xxxs font-bold text-red-600 bg-red-50 px-2 py-0.5 rounded-md border border-red-100 uppercase tracking-wider">Exp &lt; 30 Days</span>
                       </div>
                    </div>
                    ...
                    <div className="bg-gradient-to-br from-amber-50 to-orange-50 rounded-2xl p-5 border border-amber-200 flex justify-between items-center mt-5">
                       <div className="flex items-center gap-3">
                          ...
                          <span className="text-xxs font-bold text-amber-800 uppercase tracking-widest">Wasted Working Capital</span>
                       </div>
          ...
          >
            <div className="flex-1 space-y-5">
              <span className="text-sm font-bold text-indigo-600 bg-indigo-50 px-3 py-1 rounded-lg border border-indigo-200 inline-block w-fit">
                Staff Headaches
              </span>
            ...
            <div className="flex-1 w-full">
              <div className="bg-[#0B1222]/80 backdrop-blur-xl rounded-3xl p-8 relative overflow-hidden group-hover:shadow-float group-hover:shadow-indigo-500/10 transition-all duration-500 border border-white/10">
                 ...
                 <div className="text-xxs font-bold text-indigo-300 uppercase tracking-wider mb-6 relative z-10 flex items-center justify-between">
                    <span>Daily Reconciliation</span>
                    <span className="bg-white/10 px-2 py-0.5 rounded text-xxxs text-white">End of Day</span>
                 </div>
                 ...
                 <div className="space-y-3 relative z-10">
                    <div className="flex justify-between items-center bg-white/5 border border-white/10 p-4 rounded-xl backdrop-blur-sm">
                       ...
                       <span className="text-base font-bold text-white font-mono tracking-tight">₹24,500</span>
                    </div>
                    <div className="flex justify-between items-center bg-white/5 border border-white/10 p-4 rounded-xl backdrop-blur-sm">
                       <span className="text-xs text-indigo-100/70 font-bold uppercase tracking-wider">Drawer Actual</span>
                       <span className="text-base font-bold text-white font-mono tracking-tight">₹22,100</span>
                    </div>
          ...
          >
            ...
            <div className="flex-1 w-full">
              <div className="bg-[#0B1222]/80 backdrop-blur-xl rounded-3xl p-8 relative overflow-hidden group-hover:shadow-float group-hover:shadow-red-500/10 transition-all duration-500 min-h-[380px] flex flex-col border border-white/10">
                 <DarkAtmosphere withMouseEffect={false} />
                 
                 <div className="absolute bottom-[-10%] right-[-10%] w-64 h-64 bg-red-500/10 rounded-full blur-[80px] pointer-events-none"></div>
                 
                 <div className="text-xxs font-bold text-indigo-200/80 uppercase tracking-wider mb-6 relative z-10 flex items-center justify-between">
                    <span>Patient Lifetime Value</span>
                    <span className="bg-red-500/20 text-red-300 px-2 py-0.5 rounded text-xxxs uppercase tracking-wider font-bold animate-pulse border border-red-500/30">Lost Earnings</span>
                 </div>
                    ...
                    <div className="space-y-4">
                       <div className="relative pl-6 border-l-2 border-emerald-500/50">
                          ...
                          <div className="flex justify-between items-end">
                             <div>
                                <div className="text-xxs font-bold text-indigo-200/60 uppercase tracking-widest mb-1">Consultation</div>
                       ...
                       <div className="relative pl-6 border-l-2 border-red-500/50">
                          ...
                          <div className="flex justify-between items-end">
                             <div>
                                <div className="text-xxs font-bold text-indigo-200/60 uppercase tracking-widest mb-1">12-Month Medicine Refills</div>
                          ...
                          <p className="mt-3 text-xs text-red-200/90 bg-red-500/10 px-3 py-2 rounded-lg border border-red-500/20 leading-relaxed backdrop-blur-sm font-medium">
