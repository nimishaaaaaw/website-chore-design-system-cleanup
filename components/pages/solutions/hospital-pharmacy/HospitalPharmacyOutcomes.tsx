  ...
  return (
    <section id="business-case" className="section-py bg-slate-950 relative overflow-hidden">
      ...
      <div className="container-page relative z-10">
        {/* Header */}
        <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} variants={fadeInUp} className="max-w-3xl mb-16 space-y-4 mx-auto text-center">
          <div className="eyebrow-wrap justify-center">
            <span className="eyebrow-line-l bg-emerald-500/30" />
            <span className="eyebrow-text text-emerald-400 uppercase tracking-tighter">The Comprehensive Impact</span>
            <span className="eyebrow-line-r bg-emerald-500/30" />
          </div>
          <h2 className="text-h2 font-black tracking-tight text-white leading-[1.1] md:text-5xl">
            ...
            <span className="text-emerald-400">Zero headaches for you.</span>
          </h2>
          <p className="text-body-lg text-slate-400 font-medium max-w-2xl mx-auto mt-4">
            A MediKloud partnership isn't just about plugging revenue leaks. It's a holistic upgrade that removes your daily stress, ensures continuous care, and naturally grows your margins.
          </p>
        </motion.div>
        ...
        >
          ...
          <motion.div variants={fadeInUp} className="bg-white/[0.03] border border-white/10 rounded-[2.5rem] p-8 lg:p-10 relative overflow-hidden group hover:bg-white/[0.05] hover:border-slate-500/30 transition-all duration-500 flex flex-col">
            ...
            <h3 className="text-2xl font-black text-white tracking-tight mb-3">Zero Operational Stress</h3>
          ...
          <motion.div variants={fadeInUp} className="bg-gradient-to-br from-indigo-900/40 to-violet-900/40 border border-indigo-500/20 rounded-[2.5rem] p-8 lg:p-10 relative overflow-hidden group hover:border-indigo-500/50 transition-all duration-500 flex flex-col shadow-2xl shadow-indigo-900/20">
            ...
            <h3 className="text-2xl font-black text-white tracking-tight mb-3 relative z-10">Unbroken Patient Care</h3>
            <p className="text-indigo-100/70 font-medium leading-relaxed relative z-10">
          ...
          <motion.div variants={fadeInUp} className="bg-white/[0.03] border border-white/10 rounded-[2.5rem] p-8 lg:p-10 relative overflow-hidden group hover:bg-white/[0.05] hover:border-rose-500/30 transition-all duration-500 flex flex-col">
            ...
            <h3 className="text-2xl font-black text-white tracking-tight mb-3">Eliminated Inventory Risk</h3>
            <p className="text-slate-400 font-medium leading-relaxed">
          ...
          <motion.div variants={fadeInUp} className="bg-white/[0.03] border border-white/10 rounded-[2.5rem] p-8 lg:p-10 relative overflow-hidden group hover:bg-white/[0.05] hover:border-emerald-500/30 transition-all duration-500 flex flex-col">
            ...
            <h3 className="text-2xl font-black text-white tracking-tight mb-3">Upgraded Margins & Revenue</h3>
            <p className="text-slate-400 font-medium leading-relaxed">
