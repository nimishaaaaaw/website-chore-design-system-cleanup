    ...
    <section id="business-case" className="section-py relative overflow-hidden">
      ...
      <div className="container-page relative z-10">
        ...
        >
          ...
          <motion.div variants={fadeInUp} className="bg-indigo-600/10 backdrop-blur-3xl border border-white/10 rounded-3xl p-8 lg:p-10 relative overflow-hidden flex flex-col shadow-float">
          ...
          <motion.div variants={fadeInUp} className="bg-rose-500/5 backdrop-blur-3xl border border-white/10 rounded-3xl p-8 lg:p-10 relative overflow-hidden flex flex-col shadow-float">
          ...
          <motion.div variants={fadeInUp} className="bg-emerald-500/5 backdrop-blur-3xl border border-white/10 rounded-3xl p-8 lg:p-10 relative overflow-hidden flex flex-col shadow-float">
