      ...
      <div className="container-page relative z-10">
        <div className="max-w-5xl mx-auto text-center space-y-12">
          ...
          <motion.div
            ...
            viewport={{ once: true }}
            className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-white/5 border border-white/10 text-xs font-bold backdrop-blur-md shadow-float tracking-wide no-select"
          ...
          <div className="space-y-6">
            <motion.h2
              ...
              viewport={{ once: true }}
              className="text-display-sm md:text-display-md lg:text-display-lg font-bold text-white leading-[1.05] tracking-tight px-4"
            >
              Start capturing the <br className="hidden md:block" />
              <span className="text-indigo-400">value you're creating.</span>
            </motion.h2>
            ...
            <motion.p
              ...
              whileInView={{ opacity: 1, y: 0 }}
              viewport={{ once: true }}
              className="text-body-lg md:text-xl max-w-2xl mx-auto font-medium leading-relaxed"
              style={{ color: 'var(--brand-100)' }}
            >
          ...
          <div className="grid sm:grid-cols-3 gap-6 max-w-4xl mx-auto pt-6 px-4 sm:px-0">
            {[
              { icon: Activity,    title: "Revenue recovery", subtitle: "from day one",      color: "text-brand-400" },
              { icon: HeartPulse, title: "Seamless patient",  subtitle: "lifecycle",          color: "text-brand-500" },
              { icon: ShieldCheck, title: "Hands-off",        subtitle: "operations",         color: "text-brand-indigo-600" }
            ].map((item, i) => (
              <div key={i} className="card-dark p-8 rounded-3xl backdrop-blur-md group hover:bg-white/[0.07] hover:border-white/20 transition-all duration-500 text-left relative overflow-hidden">
                ...
                <p className="font-bold text-white text-lg leading-tight">
                  {item.title} <br />
                  <span className="text-slate-500 group-hover:text-slate-400 transition-colors uppercase text-xs tracking-widest block mt-1">{item.subtitle}</span>
                </p>
              </div>
            ))}
          </div>
          ...
          >
            <button
              ...
              className="group btn-dark-cta min-w-280px"
            >
              Partner With Us
            ...
            <button
              ...
              className="btn-ghost px-8 py-3.5 border-white/10 hover:bg-white/5 text-white/70 hover:text-white"
            >
