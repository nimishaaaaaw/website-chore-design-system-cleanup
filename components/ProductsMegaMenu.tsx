...
export default function ProductsMegaMenu() {
  return (
    <div className="w-[340px] p-4">
      ...
      <div className="mt-6 pt-4 border-t border-slate-50 px-2 text-center">
        <Link 
            href="/products" 
            className="group inline-flex items-center gap-2 text-[10px] font-bold text-slate-900 hover:text-blue-600 transition-colors focus-visible:outline-none uppercase tracking-wider"
        >
          View Full Suite
