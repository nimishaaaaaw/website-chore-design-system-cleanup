...
export const metadata = getMetadata({
  ...
  description: 'Upgrade your hospital pharmacy with a fully managed operations layer and free enterprise MediKloud HMS. Stop revenue leakage and automate inventory with zero capex.',
        ...
        <HospitalPharmacyHero>
          <div className="space-y-6 md:space-y-8">
            ...
            <p className="hero-subtitle max-w-[700px] mx-auto lg:mx-0 leading-relaxed text-slate-500/90">
              Every consultation ends with a prescription. But your revenue and care continuity leave the moment they walk out. MediKloud and MediKloud HMS help you capture that value right inside your hospital.
            </p>
          </div>
        </HospitalPharmacyHero>
