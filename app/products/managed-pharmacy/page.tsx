        ...
        <MPHero>
          <div className="space-y-6 md:space-y-8">
            ...
            <p className="hero-subtitle max-w-[700px] mx-auto lg:mx-0 leading-relaxed text-slate-500/90">
              Stop losing prescriptions to external retail chains. MediKloud provides the capital, MediKloud HMS, and pharmacists to capture that revenue internally—with zero operational load.
            </p>
          </div>
        </MPHero>
        <MPProblemGrid />
