...
import { getModernCardTheme } from '@/components/theme'
    ...
    >
      <div className="w-full flex flex-col items-center px-4 sm:px-6 lg:px-8">
        ...
        >
          <div
            className={cn(
              'relative grid grid-cols-1 items-start p-4 sm:p-6 md:p-8 lg:p-8 rounded-2xl',
              card.image ? 'md:grid-cols-2 gap-6 lg:gap-8' : 'max-w-3xl mx-auto text-center',
              sectionTheme.cardBg
            )}
          >
            <div className={cn('text-neutral-900 flex flex-col h-full py-2 min-h-[24rem]', !card.image && 'items-center')}>
              {/* Top Section - Tag and Title */}
              <div className={cn('space-y-3 mb-6', !card.image && 'flex flex-col items-center')}>
                {card.tag && (
                  <div className="flex items-center gap-2">
                    ...
                    >
                      {card.theme.icon && <span className="text-sm leading-none">{card.theme.icon}</span>}
              ...
              {card.chips && card.chips.length > 0 && (
                <div className="mt-4">
                  <div className={cn('flex flex-wrap gap-2', !card.image && 'justify-center')}>
