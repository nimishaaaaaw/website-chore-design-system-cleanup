    ...
    <section id="contact" className="py-8 md:py-12 bg-gradient-to-br from-gray-900 via-blue-900 to-cyan-900 relative overflow-hidden">
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8 lg:gap-10 items-start">
          <div>
            <div className="text-cyan-400 font-bold tracking-wider uppercase text-sm mb-2 md:mb-3">Get Started</div>
            <h2 className="text-3xl md:text-4xl font-bold text-white mb-4 leading-tight">Your pharmacy revenue<br className="hidden md:block"/> is waiting. Let's recover it.</h2>
            <p className="text-sm md:text-base text-gray-200 mb-8 leading-relaxed max-w-lg">Free 30-minute discovery call. We audit your current pharmacy setup, show you exactly what is leaking, and hand you a recovery plan — no commitment required.</p>
            <div className="space-y-5">
              {[
                { icon: CheckCircle, text: '30–40% avg. pharmacy revenue recovered across our pilot hospitals' },
                { icon: Zap, text: '₹0 capex — no setup cost, no hardware, no licensing' },
                { icon: Zap, text: 'Live in 7 days — we deploy staff, tech, and inventory end-to-end' },
                { icon: CheckCircle, text: 'Currently live in Visakhapatnam — 3 design partner clinics operating now' },
              ].map((item, index) => (
          ...
          <div className="bg-white/10 backdrop-blur-xl p-6 md:p-8 rounded-2xl border border-white/20">
            ...
            >
              ...
              {[
                ...
                { id: 'company', label: 'Clinic/Hospital Name', type: 'text', name: 'company', placeholder: 'Enter your organization name', required: true },
              ].map((field) => (
                <div key={field.id}>
