        ...
        <div className="hidden lg:flex sticky top-16 h-[calc(100vh-4rem)] bg-white border-r flex border-transparent justify-start w-[22rem] md:w-[26rem] lg:w-[28rem] xl:w-[30rem] border-t-0 border-l-0 opacity-100 font-light flex-col items-stretch p-0 gap-0 mx-0 text-slate-400">
          <div className="flex h-full w-full flex-col px-8 py-8">
            <div className="sticky top-0 z-10 bg-white pt-2 pb-3">
              <h2 className="text-3xl md:text-4xl font-bold mb-2 text-transparent bg-clip-text bg-gradient-to-r from-blue-600 via-purple-600 to-teal-600 leading-tight">Why MediKloud</h2>
              <p className="text-sm font-semibold text-slate-700 leading-relaxed mb-0.5">Why it works for your hospital</p>
              <p className="text-sm text-slate-500 leading-relaxed">MediKloud closes the revenue gaps that independent hospitals and clinics lose money through — every single day.</p>
            </div>
