          ...
          >
            ...
            <span className="flex items-center justify-center gap-3 sm:gap-4 mb-6 sm:mb-8">
              ...
              <span className="text-[11px] sm:text-[13px] font-bold uppercase tracking-[0.2em] text-blue-600">
                India&apos;s First Tech-Driven
              </span>
              <span className="h-[2px] w-12 sm:w-20 bg-gradient-to-l from-transparent to-blue-500 rounded-full opacity-70" />
            </span>
            <span className="block text-[2rem] sm:text-[2.5rem] md:text-[3rem] lg:text-[3.25rem] font-bold leading-[1.15] tracking-[-0.02em] text-slate-800 mb-2 md:mb-3">
              Fully Managed
            </span>
            <span className="block text-[2.25rem] sm:text-[2.75rem] md:text-[3.25rem] lg:text-[3.5rem] font-black leading-[1.08] tracking-[-0.03em] bg-gradient-to-r from-blue-700 via-indigo-600 to-violet-600 bg-clip-text text-transparent mb-4 md:mb-6">
              Hospital Pharmacy Operations
            </span>
            <span className="block text-base sm:text-lg md:text-xl font-medium text-slate-500 italic tracking-normal mt-2 md:mt-4">
